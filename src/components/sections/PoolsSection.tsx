  ...
  return (
    <section className="w-full bg-[#FFF6F1] py-24 px-0">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start px-6">
        ...
        <div className="w-full my-auto md:w-[35%] flex flex-col justify-center items-center md:items-start text-left">
          <span className="text-[#FFD166] text-sm font-semibold mb-2 tracking-widest uppercase">
            LOREM IPSUM
          </span>
          <h2 className="text-5xl  font-semibold text-[#210B0B] mb-2 md:mb-10">
            Our Pools
          </h2>
          <p className="text-lg pb-12 md:pb-2 text-[#210B0B] opacity-70">
            Lorem ipsum dolores.
          </p>
        </div>
        ...
        <div className="w-full md:w-[65%] flex flex-col md:flex-row gap-8 justify-end">
          {/* Permanent Pool Card */}
          <div className="bg-[#FFF6F1] shadow-2xl rounded-4xl w-full flex flex-col">
          ...
          <div className="bg-[#FFF6F1] rounded-4xl shadow-2xl w-full flex flex-col">
            <div className="py-4 px-4">
              <div className="flex items-center gap-2">
                <Image
                  src="/con-small.svg"
            ...
            <div className="bg-white rounded-4xl shadow-md py-6 w-full flex flex-col gap-2">
              ...
              <div className="text-sm text-[#55311599] px-4 flex flex-col gap-[.4rem]">
                <div className="flex justify-between">
                  <span>Average APY</span>
                  <span className="font-medium text-[#1E0A0A]">16%</span>
                </div>
                <div className="flex justify-between">
                  <span>Total Interest Earned</span>
                  <span className="font-medium text-[#1E0A0A]">$0.00</span>
                </div>
                <hr className="border-[#FAE8DD] my-2" />
                <div className="flex justify-between">
                  <span>Interest Schedule</span>
                  <span className="font-medium text-[#1E0A0A]">Once</span>
                </div>
                <div className="flex justify-between">
                  <span>Next Interest Date</span>
                  <span className="font-medium text-[#1E0A0A]">12/12/2025</span>
