  ...
  return (
    <section className="w-full bg-[#FFF6F1] py-20 px-0">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-12 px-6">
        {/* For Investors Card */}
        <div className="relative flex-1 bg-white rounded-3xl shadow p-10 flex flex-col justify-between overflow-visible">
          {/* Floating Icon */}
          <div className="absolute -top-22 -right-5 z-10">
            <Image src="/per-big.svg" alt="Sun Icon" width={260} height={260} />
          </div>
          ...
          <div className="mt-6">
            ...
            <button className="bg-[#1E0A0A] text-white rounded-full px-8 py-3 text-base font-medium w-fit z-20">
              Learn more
            </button>
          </div>
        </div>
